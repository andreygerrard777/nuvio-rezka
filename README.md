...
| Озвучки | **усі**, українські першими; одне посилання на озвучку |
| Якість | справжня 720p (найкраща, яку Rezka віддає без підписки) |
...
### Якість: що насправді віддає Rezka

Без підписки мітки сайту завищені на один щабель (перевірено ffprobe на кількох назвах):
«1080p» = 1280×720, «720p» = 854×480, «480p» = 360p, «360p» = 240p. «1080p Ultra», «2K» і
«4K» ведуть на одну й ту саму 60-секундну заглушку «підключіть підписку». Тому плагін:

- відкидає преміум-мітки;
- один раз на кожне відкриття джерел читає заголовок MP4 (64 КБ) і визначає справжню
  роздільність (якщо не вдалося, вважає зсув на один щабель);
- показує для кожної озвучки лише посилання ≥ 720p; якщо такого немає, лишає найкраще
  доступне, щоб озвучка не зникла.
...
субтитри), після фільтрації — рівно одне посилання 720p на озвучку; «Пуститися берега» S5E16: 9/9 озвучок, українська перша.
